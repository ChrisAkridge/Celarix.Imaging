...
{
    [Verb("BinaryDrawMultipleFiles", HelpText = "Draws the contents of multiple files onto a single image.")]
    internal sealed class BinaryDrawMultipleFiles
    {
        ...
        [Option('i', "input", Required = true, HelpText = "Depending on the value of the -o/--option parameter, either a single path to a text file containing file paths, " +
            "or a comma-delimited list of file paths, which are used in order to build the image.")]
        public string Input { get; set; }

        [Option('o', "output", Required = true, HelpText = "The path to save the image to.")]
