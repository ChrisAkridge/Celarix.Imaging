using Celarix.Imaging.ImagingPlayground.KPImageViewer;
...
namespace Celarix.Imaging.ImagingPlayground.KPImageViewer
{
    partial class KpImageViewer
    {
        ...
        private void InitializeComponent()
        {
			...
			this.pbFull = new PanelDoubleBuffered();
			...
			// btnMode
			// 
			this.btnMode.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnSelect;
			...
			// btnPreview
			// 
			this.btnPreview.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnPreview;
			...
			// btnFitToScreen
			// 
			this.btnFitToScreen.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnFitToScreen;
			...
			// btnZoomIn
			// 
			this.btnZoomIn.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnZoomIn;
			...
			// btnZoomOut
			// 
			this.btnZoomOut.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnZoomOut;
			...
			// btnRotate270
			// 
			this.btnRotate270.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnRotate270;
			...
			// btnRotate90
			// 
			this.btnRotate90.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnRotate90;
			...
			// btnOpen
			// 
			this.btnOpen.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnOpen;
			...
			// btnBack
			// 
			this.btnBack.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnBack;
			...
			// btnNext
			// 
			this.btnNext.Image = Celarix.Imaging.ImagingPlayground.Properties.Resources.btnNext;
